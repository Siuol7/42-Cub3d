...
/*   Updated: 2025/06/09 09:47:21 by caonguye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			render_px_cpy(mlx_image_t *dst,	mlx_image_t *src,
				int32_t copy_till_x, int32_t copy_till_y);
void		render_px_del(uint8_t *start_px, uint32_t img_width,
